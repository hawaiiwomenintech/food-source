<template>
  ...
  >
    <q-toolbar slot="header" class="glossy">
      ...
      <q-toolbar-title>
        Hawaii Food Source and Consumption Project
        <div slot="subtitle">Hawaii Women in Technology Project 1</div>
      </q-toolbar-title>
    </q-toolbar>
    ...
    <div slot="left">
      ...
      <q-list no-border link inset-delimiter>
        <q-list-header>Learn about our project</q-list-header>
        <q-item @click="launch('http://quasar-framework.org')">
          <q-item-side icon="school" />
          <q-item-main label="Questions" sublabel="quasar-framework.org" />
        </q-item>
        <q-item @click="launch('http://forum.quasar-framework.org')">
          <q-item-side icon="record_voice_over" />
          <q-item-main label="Data" sublabel="data sources" />
        </q-item>
        <q-item @click="launch('https://gitter.im/quasarframework/Lobby')">
          <q-item-side icon="chat" />
          <q-item-main label="Visualization" sublabel="Quasar Lobby" />
        </q-item>
      </q-list>
    </div>
